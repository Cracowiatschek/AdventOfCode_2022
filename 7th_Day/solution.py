# part 1| *
lines = [x.strip().split() for x in open('input.txt', 'r')]
...
print(f"Summary sizes under 100 000: \033[32m{str(sum(s for s in all_sizes if s < 100_000))}\033[0m")

# Part Two
size_free = 70_000_000 - all_sizes[0]
for d in sorted(all_sizes):
    if size_free + d >= 30_000_000:
        print(f"The smallest directory is: \033[32m{str(d)}\033[0m")
        break
